          ...
          <div class="col-12 grid-margin ">
            <div class="card shadow">
                <div class="card-header bg-dark text-white">
                    <h4 class="my-auto text-center">All Accepted Orders</h4>
                </div>
              <div class="card-body">
                <div class="row">
                    <div class="col-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($order->order_status=='Accepted')
                                        <a href="{{ route('update_order_status',[$order->order_id,'Completed']) }}" class="btn btn-success mt-1"><i class="fa fa-check"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
